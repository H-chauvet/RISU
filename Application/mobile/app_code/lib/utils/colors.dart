...
class MyColors {
  static const Color primary = Color(0xFF0F3F62);
  static const Color secondary = Color(0xFF2996CE);
  static const Color buttonBackground = Color(0xFFCDE8F1);
  static const Color buttonText = Color(0xFF2996CE);
